<template>
	<div style="position: fixed;top: 0;z-index: 9;width: 100%;background: #FFFFFF;min-height: 100%;">
		...
		<div class="zfb">
			...
			<div class="wen">支付宝</div>
			<input type="radio" style="width: 0.625rem;height: 0.625rem;background-color: #4cd964;">
		</div>
		<div class="zfb">
			<div class="icon-wx"></div>
			<div class="wen">微信</div>
			<input type="radio" style="width: 0.625rem;height: 0.625rem;background-color: #4cd964;">
		</div>
